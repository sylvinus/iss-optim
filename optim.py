...
VARS = [
  ...
  ["backpanels_angle",-0.3,0.3,True],
  ["frontpanels_angle",-0.3,0.3,True],
  ...
  ["fast_cycle_1_start",toalpha(0),toalpha(10),1 in do_cycles],
  ["fast_cycle_1_length",0,1,1 in do_cycles],
  ["fast_cycle_1_prelength",0,1,1 in do_cycles],

  ["fast_cycle_2_start",toalpha(10),toalpha(20),2 in do_cycles],
  ["fast_cycle_2_length",0,1,2 in do_cycles],
  ["fast_cycle_2_prelength",0,1,2 in do_cycles],

  ["fast_cycle_3_start",toalpha(20),toalpha(35),3 in do_cycles],
  ["fast_cycle_3_length",0,1,3 in do_cycles],
  ["fast_cycle_3_prelength",0,1,3 in do_cycles],

  ["fast_cycle_5_start",toalpha(35),toalpha(50),4 in do_cycles],
  ["fast_cycle_5_length",0,1,4 in do_cycles],
  ["fast_cycle_5_prelength",0,1,4 in do_cycles],

  ["fast_cycle_4_start",toalpha(50),toalpha(70),5 in do_cycles],
  ["fast_cycle_4_length",0,1,5 in do_cycles],
  ["fast_cycle_4_prelength",0,1,5 in do_cycles],

  ["fast_cycle_6_start",toalpha(70),toalpha(91),6 in do_cycles],
  ["fast_cycle_6_length",0,1,6 in do_cycles],
  ["fast_cycle_6_prelength",0,1,6 in do_cycles],

  ["fast_cycle_7_start",toalpha(0),toalpha(91),7 in do_cycles],
  ["fast_cycle_7_length",0,1,7 in do_cycles],
  ["fast_cycle_7_prelength",0,1,7 in do_cycles],

  ["fast_cycle_8_start",toalpha(0),toalpha(91),8 in do_cycles],
  ["fast_cycle_8_length",0,1,8 in do_cycles],
  ["fast_cycle_8_prelength",0,1,8 in do_cycles]
